    ...
    if (interaction.isChatInputCommand()) {
      ...
      if(interaction.customId === "guia") {
        ...
        const canales = new EmbedBuilder()
            .setDescription('# GUÍA CANALES TEAM KNX\n\n**Aquí se encuentra la información tanto de canales de interacción, sociales y a su vez de los roles disponibles en el servidor.**\n\n>>> <#1145687187409612942> : Lugar donde mandar memes, videos o cualquier cosa para hacer reír a kirinuxx en un directo especial\n<#700911264645513226>:  Canal para ver las notmas de este servidor\n<#1016169722296938517>: Canal donde puedes encontrar información sobre el servidor\n<#1016169782854295594>: Canal donde se anuncian las actualizaciones del servidor\n<#1145307912785383455>: Canal donde se publican los eventos del servidor\n<#1016169843441008650>: Las redes de Kirinuxx\n<#1020324112729636975>: Lugar donde se avisan los tiktoks, streams y tweets de kirinuxx\n<#1158445099835998239>:  Información acerca del canal de kirinuxx \n<#1110018733948289107>: Información de las cartas del servidor\n<#1016170169766260856>: Canal en el cuál puedes contactar con el staff\n<#1139216429267304529>: Canal donde puedes postularte a staff tanto de twitch como de discord\n<#1161685203845140531> y <#1182001310946566255> : Canales en los cuales puedes ver los logros y maestrías del sevidor\n<#1016170761968431217>: Aquí se activaran algunos sorteos\n<#1016372022797938768>: Aquí se pondran  encuestas para ayudar al servidor, o decidir sobre algun tema\n<#1109224777593405510>: Aqui se pondra jna pregunta al dia si aciertas el primero, premio\n<#1023384595208601684>: Habla y disfruta con gente del server\n<#1116393257971236966>: Chat gpt, responde todo\n<#1016170618720354394>: Pasa fotos y videos\n<#1016170652778102835>: Pasa tus memes\n<#1016171578771374131>: Usa los comandos de el servidor\n<#1146123031987626004>: Metete en un canal de voz y pon aqui la musica que quieras\n<#1137772994463285269>: Apunta tus ideas \n<#1016170729785544814>: Aqui se te  recordara tu cumpleaños \n<#1157749702041817168> : Escribe las letras de tus canciones favoritas \n<#1003643729430716537>: Información sobre las futuras actualizaciones de brawl\n<#1016171157474517042> : Mira tus stats de brawl')
            .setColor('#0be4db')
